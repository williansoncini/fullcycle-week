...
export class Map {
  ...
  moveCurrentMarker(id: string, position: google.maps.LatLngLiteral) {
    // if (id in this.routes)
    console.log(this.routes[id].currentMarker.getPosition()?.toString())
    this.routes[id].currentMarker.setPosition(position);
    console.log(this.routes[id].currentMarker)
    // const myLatlng = new google.maps.LatLng(-25.363882,131.044922);
    // this.routes[id].currentMarker.setPosition(myLatlng);
    // console.log(this.routes[id].currentMarker.getPosition())
  }
